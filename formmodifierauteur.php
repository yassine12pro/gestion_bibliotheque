...
<div class="container">
    ...
    <form action="modifierauteur.php" method="POST"> 
            ...
            <div class="mb-3">
              ...
              <input type="text" class="form-control" id="bookAuthor" value="<?= ($livre['biographie']); ?>" name="bio"  required>
            </div>
            <div class="mb-3">
              <label for="bookGenre" class="form-label">Date de Naissance</label>
              <input type="date" class="form-control" id="bookGenre" name="dn" value="<?= ($livre['date_de_naissance']); ?>" required>
            </div>
